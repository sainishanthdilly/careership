...
<p> </p>
<p> <button type="button" class="btn btn-primary" onclick="window.location.href='/vjf/mailverify/resendEmailEmployer'">Resend email</button> </p>
	
<p></p>
	<p> <button type="button" class="btn btn-primary" onclick="window.location.href='/vjf/home'">Home</button>
	<button type="button" class="btn btn-primary" onclick="window.location.href='/vjf/employer/postjobs'">Post Jobs</button>   </p>
<p> </p>
