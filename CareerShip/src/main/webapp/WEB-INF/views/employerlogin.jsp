...
<head>
  ...
  function myFunction() {
    ...
    if (inpObj.checkValidity() == false) {
        document.getElementById("p").innerHTML = inpObj.validationMessage;
    } else {
        document.getElementById("p").innerHTML = "email id success";
    } 
} 

function myFunction() {
    var inpObj = document.getElementById("pwd");
    if (inpObj.checkValidity() == false) {
        document.getElementById("q").innerHTML = inpObj.validationMessage;
    } else {
        document.getElementById("q").innerHTML = "password success";
    } 
}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="/vjf/employerlogin">Employer Login</a></li>
...
<div class="container">
  ...
  <form:form modelAttribute="eLogin" action="/logindoneE" method="POST"  >
    <div class="form-group">
	<div class="input-group">
      <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
      <form:input type="email" path="eName" class="form-control" id="email" placeholder="Enter email" required="required" />
    </div>
	</div>
    <div class="form-group">
	 <div class="input-group">
	  ...
	  <form:input path= "ePassword" type="password" class="form-control" id="pwd" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
